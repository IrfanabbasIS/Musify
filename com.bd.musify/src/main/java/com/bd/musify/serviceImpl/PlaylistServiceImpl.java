...
public class PlaylistServiceImpl implements PlaylistService{
    ...
    public PaginatedResponse<PlaylistResponse> getMyPlaylists(String email, int page, int size, String search) 
    {
        ...
        {
            playlistPage=playlistRepository.findByAppUserIdAndNameContainingIgnoreCaseOrAppUserIdAndDescriptionContainingIgnoreCase(appUser.getId(),search.trim(),appUser.getId(),search.trim(),pageable);
        }
        else
        {
